...
class loginWindow : public Gtk::Window {
    public:
        /**
        * @brief Constructor for loginWindow and initializes all widgets.
        *
    ...
    private:
        ...
        // Image used to display feedback or error messages on the main window.
        Gtk::Image loginImage;

        // Grid that is used
        Gtk::Grid screenGrid;

        // Boxes used to organize text and (potentially) animations.
        ...
        * @param registerImage The image which will change based on errors.
        ...
        */
        void registrationResponse(int response_id, Gtk::Dialog* dialog, 
            Gtk::Image* registerImage,                                          // RegisterImage
        ...
        *
        * Currently requires at least 8 characters with at least one letter
        * and one digit.
        *
        ...
        */
        ...
        /**
        * @brief Confirms that two password strings match exactly.
        *
        * @param newPass The original password.
        * @param confirmPass The confirmation password.
        * @return true if both passwords are identical; false otherwise.
        */
