...
class RandGen{
    private:
        //variables for the weight of each category
        ...
        //variables for the maximum amount of each category
        ...
        //variables for the amount of dropped scores of each category
        ...
        //variables for the max score each category could have
