...
void displayMenu(string user) {
  ...
  cout << "\n\n\n==================================================================================================\n"
    ...
    << "4. Class Average Grades\n"
    << "5. Sort class Grades ( Feature Unavailable: will be presenet in Lab 8) \n"
    << "6. Total Grade Above/Below Threshold ( Feature Unavailable: will be presenet in Lab 8) \n"
    << "7. Show Student Score Report\n"
    << "8. Exit and Quit\n";
}
